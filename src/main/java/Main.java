...
public final class Main {
  ...
  public static class MyPipeline implements VisionPipeline {
   //#region  
	...
	public void process(Mat source0) {
		...
		double resizeImage0Width = 208.0;
		double resizeImage0Height = 120.0;
		...
		// Step HSL_Threshold0:
		Mat hslThresholdInput = resizeImage0Output;
		double[] hslThresholdHue = {0.0, 23.406763884579615};
		double[] hslThresholdSaturation = {229.0093403122604, 254.69279354967045};
		double[] hslThresholdLuminance = {91.72661870503597, 244.12116040955632};
		...
		double[] filterContoursSolidity = {28.776978417266186, 100};
		...
		// Step Resize_Image1:
		Mat resizeImage1Input = cvErodeOutput;
		double resizeImage1Width = 104.0;
		double resizeImage1Height = 60.0;
		int resizeImage1Interpolation = Imgproc.INTER_NEAREST;
		resizeImage(resizeImage1Input, resizeImage1Width, resizeImage1Height, resizeImage1Interpolation, resizeImage1Output);

		// Step Desaturate0:
		Mat desaturateInput = resizeImage1Output;
  ...
  public static void main(String... args) {
    ...
    // start NetworkTables
    System.out.println("============================NETWORK TABLES=================================");
    NetworkTableEntry xCenter, yCenter, RectSize, ContourState;
    ...
    ContourState = table.getEntry("NoTarget"); 
    xCenter.setDouble(0);
    yCenter.setDouble(0);
    RectSize.setDouble(0);
    ContourState.setBoolean(true);
                ...
                if (!pipeline.filterContoursOutput().isEmpty()) {
                  ...
                  synchronized (imgLock) {
                    //defined as a percentage. If the resize node is changed then the 208 will have to be changed as well. same for height
                      xCenter.setDouble((r.x + (r.width / 2)) / 208.0);
                      yCenter.setDouble((r.y + (r.height / 2)) / 120.0);
